    ...
    return (
        <React.Fragment>
            <div className="container d-flex flex-column align-items-center">
                ...
                <div className="accordion accordion-flush w-50 border border-5" id="accordionFaq">
                    <div className="accordion-item">
                        ...
                        <div id="flush-collapse" className="accordion-collapse collapse" aria-labelledby="flush-heading" data-bs-parent="#accordionFaq">
